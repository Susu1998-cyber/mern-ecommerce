...
const Register = () => {
  ...
  <div className="mb-3">
    ...
    <input type="text" className="form-control" id="exampleInputPassword1" placeholder='What is your favourite sports?' value={answer} onChange={(e) => setAnswer(e.target.value)} required />
  </div>
